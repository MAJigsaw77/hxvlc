...
extern enum abstract LibVLC_Event_E(LibVLC_Event_E_Impl)
{
	...
	@:native('libvlc_MediaPlayerStopping')
	var LibVLC_MediaPlayerStopping;
...
typedef LibVLC_Media_Read_CB = cpp.Callable<(opaque:cpp.RawPointer<cpp.Void>, buf:cpp.RawPointer<cpp.UInt8>, len:cpp.SizeT) -> cpp.PtrDiffT>;
