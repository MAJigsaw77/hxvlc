...
extern class LibVLC
{
	...
	static function audio_set_callbacks(mp:cpp.RawPointer<LibVLC_MediaPlayer_T>, play:LibVLC_Audio_Play_CB, pause:LibVLC_Audio_Pause_CB, resume:LibVLC_Audio_Resume_CB,
